...
\texttt{scripts/16\_tracy\_widom\_figure.py}, numbered in the order
...
sequence); every number and figure in this paper is produced directly
by this code from the two raw downloaded files, with no intermediate
